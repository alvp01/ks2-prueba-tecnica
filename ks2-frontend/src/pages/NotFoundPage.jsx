  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
      <section className="w-full max-w-md rounded-2xl border border-brand-100 bg-white p-8 text-center shadow-panel">
        ...
        <h1 className="mt-2 font-display text-3xl font-semibold text-brand-900">Pagina no encontrada</h1>
        <p className="mt-3 text-brand-700">La pagina que solicitaste no existe.</p>
        <Link
          to="/login"
